...
class Close extends \BicicletasMilan\Helpdesk\Controller\Adminhtml\Ticket
{
	...
	public function __construct(
		...
		\BicicletasMilan\Helpdesk\Model\TicketFactory $ticketFactory,
	...
	public function execute()
	{
		...
		if ($ticket && $ticket->getId()) {
			...
			try {
			$ticket->setStatus(\BicicletasMilan\Helpdesk\Model\Ticket::STATUS_CLOSED);
			$ticket->save();
